...
const STAT_PATTERNS = [
  ...
  { re: /攻撃力\s*([+-]\d+(?:\.\d+)?)(?![\d.]|\s*%)/g, key: 'attackFlat', prop: 'flatAttack', equipProp: 'equipBuffFlatAttack', label: '攻撃力' },
  { re: /魔力\s*([+-]\d+(?:\.\d+)?)\s*%/g, key: 'magicPct', prop: 'magicPct', equipProp: 'equipBuffMagicPct', label: '魔力%' },
  { re: /魔力\s*([+-]\d+(?:\.\d+)?)(?![\d.]|\s*%)/g, key: 'magicFlat', prop: 'flatMagic', equipProp: 'equipBuffFlatMagic', label: '魔力' },
  { re: /移動速度\s*([+-]\d+(?:\.\d+)?)\s*%/g, key: 'speedPct', prop: 'speedPct', equipProp: 'equipBuffSpeedPct', label: '速度%' },
  { re: /移動速度\s*([+-]\d+(?:\.\d+)?)(?![\d.]|\s*%)/g, key: 'speedFlat', prop: 'flatSpeed', equipProp: 'equipBuffFlatSpeed', label: '速度' },
  { re: /防御力\s*([+-]\d+(?:\.\d+)?)\s*%/g, key: 'extraACPct', prop: 'extraACPct', equipProp: 'equipBuffExtraACPct', label: 'AC%' },
  { re: /防御力\s*([+-]\d+(?:\.\d+)?)(?![\d.]|\s*%)/g, key: 'flatAC', prop: 'extraAC', equipProp: 'equipBuffExtraAC', label: 'AC' },
  { re: /(?:最大)?HP\s*([+-]\d+(?:\.\d+)?)\s*%/gi, key: 'extraHPPct', prop: 'extraHPPct', equipProp: 'equipBuffExtraHPPct', label: 'HP%' },
  { re: /(?:最大)?HP\s*([+-]\d+(?:\.\d+)?)(?![\d.]|\s*%)/gi, key: 'flatHP', prop: 'extraHP', equipProp: 'equipBuffExtraHP', label: 'HP' },
  { re: /(?:最大)?MP\s*([+-]\d+(?:\.\d+)?)\s*%/gi, key: 'extraMPPct', prop: 'extraMPPct', equipProp: 'equipBuffExtraMPPct', label: 'MP%' },
  { re: /(?:最大)?MP\s*([+-]\d+(?:\.\d+)?)(?![\d.]|\s*%)/gi, key: 'flatMP', prop: 'extraMP', equipProp: 'equipBuffExtraMP', label: 'MP' },
  { re: /(?:最大)?ST\s*([+-]\d+(?:\.\d+)?)\s*%/gi, key: 'extraSTPct', prop: 'extraSTPct', equipProp: 'equipBuffExtraSTPct', label: 'ST%' },
  { re: /(?:最大)?ST\s*([+-]\d+(?:\.\d+)?)(?![\d.]|\s*%)/gi, key: 'flatST', prop: 'extraST', equipProp: 'equipBuffExtraST', label: 'ST' },
  { re: /命中(?:率)?\s*([+-]\d+(?:\.\d+)?)\s*%/g, key: 'extraHitPct', prop: 'extraHitPct', equipProp: 'equipBuffExtraHitPct', label: '命中%' },
  { re: /命中\s*([+-]\d+(?:\.\d+)?)(?![\d.]|\s*%)/g, key: 'hitFlat', prop: 'extraHit', equipProp: 'equipBuffExtraHit', label: '命中' },
  { re: /回避\s*([+-]\d+(?:\.\d+)?)\s*%/g, key: 'extraAvoidPct', prop: 'extraAvoidPct', equipProp: 'equipBuffExtraAvoidPct', label: '回避%' },
  { re: /回避\s*([+-]\d+(?:\.\d+)?)(?![\d.]|\s*%)/g, key: 'avoidFlat', prop: 'extraAvoid', equipProp: 'equipBuffExtraAvoid', label: '回避' },
  { re: /最大(?:所持可能)?重量\s*([+-]\d+(?:\.\d+)?)\s*%/g, key: 'maxWeightPct', prop: 'extraMaxWeightPct', equipProp: 'equipBuffExtraMaxWeightPct', label: '最大重量%' },
  { re: /最大(?:所持可能)?重量\s*([+-]\d+(?:\.\d+)?)(?![\d.]|\s*%)/g, key: 'flatMaxWeight', prop: 'extraMaxWeight', equipProp: 'equipBuffExtraMaxWeight', label: '最大重量' },
  { re: /攻撃ディレイ\s*([+-]\d+(?:\.\d+)?)\s*%/g, key: 'attackDelayPct', prop: 'extraAttackDelayPct', equipProp: 'equipBuffExtraAttackDelayPct', label: '攻撃ディレイ%' },
  { re: /攻撃ディレイ\s*([+-]\d+(?:\.\d+)?)(?![\d.]|\s*%)/g, key: 'attackDelayFlat', prop: 'extraAttackDelay', equipProp: 'equipBuffExtraAttackDelay', label: '攻撃ディレイ' },
  { re: /魔法ディレイ\s*([+-]\d+(?:\.\d+)?)\s*%/g, key: 'magicDelayPct', prop: 'extraMagicDelayPct', equipProp: 'equipBuffExtraMagicDelayPct', label: '魔法ディレイ%' },
  { re: /魔法ディレイ\s*([+-]\d+(?:\.\d+)?)(?![\d.]|\s*%)/g, key: 'magicDelayFlat', prop: 'extraMagicDelay', equipProp: 'equipBuffExtraMagicDelay', label: '魔法ディレイ' },
